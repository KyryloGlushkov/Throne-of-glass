...
define gui.main_menu_background = "images/main1.jpg"
...
define gui.navigation_xpos = None          # вимикаємо фіксований відступ зліва
define gui.navigation_xalign = 1.0         # вирівнюємо по правому краю (1.0 = повністю справа)
