...
image селена платьє = At("images/Selena/селена платьє.png", sprite_highlight("селена"))
image селена броня = At("images/Selena/селена броня.png", sprite_highlight("селена"))
...
image спутниця1 = At("images/Companions/Спутниця1.png",   sprite_highlight("спутниця1"))
image спутниця2 = At("images/Companions/Спутниця2.png",   sprite_highlight("спутниця2"))
...
label start:
    ...
    scene expression "images/episodes/ep1.jpg"
    with dissolve
...
scene expression "images/episodes/ep2.jpg"
with dissolve
...
scene expression "images/backgrounds/room_night.jpg"
with fade
...
scene expression "images/backgrounds/room_daylight.jpg"
with fade
...
scene expression "images/backgrounds/Main_courtyard.jpg"
with fade
...
#ворота Ендовьера
scene expression "images/backgrounds/Courtyard_entrance.jpg"
with fade
...
#Лес (The_forest)
scene expression "images/backgrounds/The_forest.jpg"
with fade
...
"Він відвернувся."
#Лес (The_forest_var2)
scene expression "images/backgrounds/The_forest_var 2.jpg"
with fade
...
scene expression "images/episodes/ep3.jpg"
with dissolve
play sound "audio/Transition.mp3"
pause 3.0
scene black
...
#Лес (The_forest_var3)
scene expression "images/backgrounds/The_forest_var 3.jpg"
with fade
...
scene expression "images/episodes/ep4.jpg"
with dissolve
...
scene expression "images/backgrounds/The_courtyard_of_the_glass_castle.jpg"
with fade
...
scene expression "images/backgrounds/Selena's Room (The Glass Castle) Day.jpg"
with fade
"Спадкоємний принц стримав слово. Покої Селени справді були в кам’яній частині замку. Більші, ніж вона уявляла: спальня з умивальнею й гардеробною, затишна їдальня, кімната для ігор і музикування."
"Скрізь витончено розставлені кушетки й м’які стільці."
...
"У спальні вона пригнулася, просклизнула до вікна, притиснулася до мармурової стіни й глянула вниз."
"Караульні, напевно, вже розрядили арбалети й повісили за спину. Зарядити знову — кілька секунд. За цей час вона встигла б заволодіти мечами, перерізати горлянки й зникнути."
...
show фаліпа at right, size_falipa, appear_fade 
show селена платьє at left, size_selena, appear_fade 
f "Мене звати Фаліпа Спандель. Я твоя особиста служниця. А ти, мабуть…"
c "Селена Сардотін"
show фаліпа at right, size_falipa, disappear_fade 
show селена платьє at left, size_selena, disappear_fade 
...
scene expression "images/backgrounds/The Glass Throne Room.jpg"
with fade
...
"Інша справа молодший брат Холлін — успадкував і кремезність, і кругле обличчя з гострими очицями."
"Дорін же — високий, стрункий, ніби народився від іншого батька. А глибокі сині очі — взагалі загадка. Таких не було навіть у матері. Залишалося лише гадати, від якого предка вони дісталися."
show король at right, appear_fade, size_king
K "Ви її привезли?"
show дорін at left, appear_fade 
pr "Поки вона тут то ніякої загрози не становить."
show дорін at left, disappear_fade 
show король at right, disappear_fade, size_king
"Селена Сардотін — претендентка спадкоємного принца. Це нагадувало азартну гру з непередбачуваним результатом. Випробування батьківського терпіння."
"Сам факт її появи в замку ще нічого не вирішував. Король міг одним словом перекреслити всі задуми сина."
show король at right, appear_fade, size_king
show дорін at left, appear_fade 
...
show дорін at left, disappear_fade 
show король at right, disappear_fade, size_king 
"Він, на щастя, не розумів, що пошуки претендента принц затіяв зовсім з іншою метою."
"Доріна цікавили не гроші й не виграш. Він ухопився за ці пошуки, щоб вирватися з-під батьківського гніту й на якийсь час відчути себе вільною людиною."
...
K "Я знаю, що кажу, Доріне, і не тобі сумніватися в моїх словах! Ти думаєш, що ця… дівка здатна перемогти. Не забувай: герцог Перрантгон виставив набагато сильнішого претендента — Кейна."
K "Ти вчинив би розумніше, якби знайшов когось йому під стать. Кейн загартований кров’ю й залізом на полях битв."
show дорін at left, disappear_fade 
show король at right, disappear_fade, size_king 
...
show дорін at left, appear_fade 
show король at right, appear_fade, size_king 
K "Я надто довго й важко працював, створюючи свою імперію, і не хочу, щоб ти ускладнював мені справу незаконними спадкоємцями."
K "Женися на гідній дівчині, подаруй мені пару онуків, а потім можеш путатися з ким завгодно. Коли сам станеш королем — зрозумієш правоту моїх слів."
...
scene expression "images/episodes/ep5.jpg"
with dissolve
...
scene black
with dissolve
scene expression "images/backgrounds/Marble Hall.jpg"
with fade
play music "audio/S&D.mp3" fadein 2.0
#Marble Hall
...
show шаол at right, size_shaol, appear_fade 
sh "Ми ж там уже були. Ми обійшли з тобою всі три сади, бальні зали, кімнати історичних подій і милувалися всіма краєвидами з вікон кам’яного замку."
sh "Якщо не хочеш гуляти скляним — більше тут дивитися нічого."
show селена платьє at left, size_selena, disappear_fade 
show шаол at right, size_shaol, disappear_fade 
"Селена склала руки на грудях. Капітан клюнув на її хитрість і справді повірив, що їй остогидло сидіти в розкішних покоях і вона хоче, щоб він поводив її замком."
"Насправді Селена видивлялася нові шляхи для втечі. До того ж їй справді нестерпно було сидіти в своїй розкішній клітці, чекаючи завтрашніх змагань."
show шаол at right, size_shaol, appear_fade 
show селена платьє at left, size_selena, appear_fade 
...
#Clock Tower
scene expression "images/backgrounds/Clock Tower.jpg"
with fade
"У цьому саду вони вже були, але з іншого боку, де Часову вежу ховали дерева."
"Тепер перед Селеною височіла похмура споруда з чорного, з чорнильним відливом, каменю. Усі чотири циферблати прикрашали парні горгульї. Їхні морди застигли в беззвучному крику."
show шаол at right, size_shaol, appear_fade 
show селена платьє at left, size_selena, appear_fade 
...
"Селена й сама рада була швидше піти, але чомусь захотілося ще раз глянути на похмуру споруду."
"Вона обернулася — і побачила, що скрючений палець однієї з горгулій вказує прямо на неї. Селена могла б заприсягтися, що чудовисько навіть трохи роззявило пащу."
...
show селена платьє at left, size_selena, disappear_fade 
show шаол at right, size_shaol, disappear_fade 
"Селена кивнула на чорну матову плитку з нерівними краями. На ній був нашкрябаний знак: коло, пересічене вертикаллю."
"Лінія трохи виступала за межі й закінчувалася гачками — один вгору, інший вниз."
show шаол at right, size_shaol, appear_fade 
show селена платьє at left, size_selena, appear_fade 
c "Що це означає?"
show селена платьє at left, size_selena, disappear_fade 
...
show селена платьє at left, size_selena, disappear_fade 
show шаол at right, size_shaol, disappear_fade 
"Селена не стала випробовувати терпіння капітана й дозволила відвести себе з саду, від похмурої вежі й чудовиськ на циферблатах."
"Разом із Шаолом вона повернулася в мармурові коридори замку, але ніяк не могла позбутися відчуття, що вирячені очі горгульї досі стежать за нею."
# The door to the library
scene expression "images/backgrounds/The door to the library.jpg"
with fade
...
show селена платьє at left, size_selena, disappear_fade 
show шаол at right, size_shaol, disappear_fade 
"Очі Селени ще більше округлилися, коли вона помітила двох драконів, що ніби охороняли вхід. Здавалося, дракони ось-ось злетять зі стіни."
"У них було по чотири лапи — не те що у злих, огидних двоногих виверн, що прикрашали королівський герб."
show шаол at right, size_shaol, appear_fade 
show селена платьє at left, size_selena, appear_fade 
sh "Бібліотека."
...
# The library
scene expression "images/backgrounds/The library.jpg"
with fade
...
scene expression "images/backgrounds/Selena's Room (The Glass Castle) Night.jpg"
with fade
...
"Думки перервалися появою трьох жінок, що вийшли з-за живої огорожі. Безтурботно балакаючи, вони йшли до фонтану."
"Жінки були майже її ровесницями, гарно вбрані, та, що йшла посередині — помітно вирізнялася вишуканістю вбрання. Обидві супутниці в скромніших блідо-блакитних сукнях скоріше за все були служницями."
"Красунька в червоному церемонно розправила поділ свого плаття."
# Garden
scene expression "images/backgrounds/Garden.jpg"
with fade
...
show спутниця1 at left, appear_fade, size_companion
spk1 "Накажете перевдягнути Вас?"
ka "Ні, мені подобається ця сукня, хоч вона й далеко не нова."
show спутниця1 at left, disappear_fade, size_companion 
show спутниця2 at left, appear_fade, size_companion 
spk2 "Але…"
show кальтена at right, size_kaltena, disappear_fade 
show спутниця1 at left, disappear_fade, size_companion 
show спутниця2 at left, disappear_fade, size_companion 
...
scene expression "images/backgrounds/The door to the glass throne room.jpg"
with fade
...
scene expression "images/episodes/ep6.jpg"
with dissolve
...
show король at right, disappear_fade, size_king 
# Hallway
scene expression "images/backgrounds/Hallway.jpg"
with fade
...
show шаол at right, size_shaol, appear_fade 
show селена броня at left, size_selena, appear_fade 
...
show селена броня at left, size_selena, disappear_fade 
show шаол at right, size_shaol, disappear_fade 
# Hallway2
scene expression "images/backgrounds/Hallway2.jpg"
with fade
...
# Training room
scene expression "images/backgrounds/Training room.jpg"
with fade
...
show кейн at right, appear_fade, size_kane
ke "Доброго ранку"
show кейн at right, disappear_fade, size_kane
...
scene black
with fade
scene expression "images/episodes/ep7.jpg"
with dissolve
play sound "audio/Transition.mp3"
pause 3.0
scene black
...
show кейн at left, appear_fade, size_kane 
show брулло at right, appear_fade 
ke "Моє ім’я Кейн. Солдат королівської армії. Родом із Білокличих гір."
show кейн at left, disappear_fade, size_kane 
show брулло at right, disappear_fade 
"Він не брехав. Селена чула, що жителі тих глухих місць вирізняються особливою жорстокістю. Коли адарланське панування дотягнулося й туди, білокличники піднімали бунт за бунтом."
"Що б сказали родичі Кейна, якби дізналися, де він зараз? Подумавши про це, Селена стиснула зуби. А що б про неї сказали жителі Террасену?"
...
"Селена з усіх сил старалася не дивитися на його понівечений шрамами рот. Ім’я другого вона запам’ятала: Нід. Три роки він орудував під прізвиськом Коса."
"Коса була його улюбленим знаряддям, за допомогою якого він катував і знущався з жертв, «скосячи» шматки їхніх тіл. Дивно, що обох злочинців досі не стратили."
...
#Garden2
scene expression "images/backgrounds/Garden2.jpg"
with fade
show селена броня at left, size_selena, appear_fade 
show шаол at right, size_shaol, appear_fade 
...
#Running competition
scene expression "images/backgrounds/Running competition.jpg"
with fade
...
scene expression "images/backgrounds/Selena's Room (The Glass Castle) Cloudy.jpg"
with fade
...
scene expression "images/backgrounds/Selena's Room (The Glass Castle) Cloudy.jpg"
with fade
"Наступного ранку Шаолу вже не довелося будити Селену. Увійшовши до її спальні, капітан застав колишню в’язницю Ендов’єра за дивним заняттям."
"Селена підтягувалася, вхопившись за дверний карниз і прагнучи дістати його підборіддям. Ці вправи тривали вже цілу годину. У Селени тремтіли руки, і кожен новий підхід давався їй дедалі важче."
...
scene expression "images/backgrounds/Hallway2.jpg"
with fade
"Того дня вибухнула сильна злива. Ні про яке змагання в бігу не могло бути й мови — і претендентів відпустили раніше. Потім злива вщухла так само раптово, як і почалася."
"Шаол запропонував Селені прогулятися садами. Капітан не був налаштований на розмову, але вона все одно раділа прогулянці. Їй набридло замкнутий простір кімнат."
"Селена вбралася в нову шовкову бузкову сукню з блідо-рожевими мереживами, розшитими перлинними бусинками. Вона пройшла разом із капітаном зовсім небагато, коли, завернувши за ріг, ледь не зіткнулася з Кальтеною Ромпір."
"На щастя, та була не сама і її супутниця, ейлуейська жінка, одразу привернула увагу Селени."
...
"А коли вона зійде на престол Ейлуе, король Адарлану отримає грізну противницю, яка покладе край його пануванню над її рідною країною."
"Захопленим шепітом вони розповідали Селені, що принцеса допомагає повстанським групам, які ховаються в різних куточках Ейлуе, постачаючи їм припаси й передаючи відомості про наміри адарланських загарбників."
...
show шаол at right, size_shaol, disappear_fade 
"Принцеса вслухалася в його слова, не приховуючи, що погано розуміє адарланську. Водночас вона поглядала на Селену, запрошуючи її зіграти роль перекладачки."
"Селена усміхнулася. Тепер зрозуміло, чому «двоногий хробак» обливається потом. Красуня Нехемія являла собою ту силу, з якою мимоволі доводиться рахуватися."
...
# scene black
# with fade
# scene expression "images/episodes/ep8.jpg"
# with dissolve
# play sound "audio/Transition.mp3"
# pause 3.0
# scene black
# with dissolve
# scene expression "images/backgrounds/Training room (light frost).jpg"
# with fade
# play music "audio/S&D.mp3" fadein 2.0
...
# scene expression "images/backgrounds/Selena's Room (The Glass Castle) light frost.jpg"
# with fade
# "Минув деякий час"
...
# scene expression "images/backgrounds/Training room (dartboards).jpg"
# with fade
...
# scene expression "images/backgrounds/Training room (dartboards2).jpg"
# with fade
...
# scene black
# with fade
# scene expression "images/episodes/ep9.jpg"
# with dissolve
# play sound "audio/Transition.mp3"
# pause 3.0
# scene black
# with dissolve
# scene expression "images/backgrounds/Hill.jpg"
# with fade
# play music "audio/S&D.mp3" fadein 2.0
# #Hill
...
# #Training room (empty)
# scene expression "images/backgrounds/Training room (empty).jpg"
# with fade
